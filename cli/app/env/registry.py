    ...
    def discover(
        ...
        Args:
            descriptor_dir: directory containing JSON descriptors. Defaults to
                ``cli/registry/environments/`` (derived from this file).
...
# ------------------------------------------------------------------
# Module-level lazy singleton (process-wide)
#
...
def get_env_registry() -> "EnvironmentRegistry":
    """Return the process-wide :class:`EnvironmentRegistry`, discovering on
    first use with the writable overlay (``<output_dir>/registry``)."""

...
Tests the env.list / env.add / env.delete handlers.  Uses temporary overlay
directories and a real EnvironmentRegistry so descriptor writes and
re-discovery are exercised end-to-end.
"""
